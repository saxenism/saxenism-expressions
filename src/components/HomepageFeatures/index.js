    ...
    description: (
      ...
      <p style={{textAlign: 'center'}}>Clients that I have helped secured, either via private audits, audit contests or bug bounties.</p>
        <ul className={styles.unnamedList}>
          <li style={{textAlign: 'left'}}> <b> [BOUNTY] &nbsp; &nbsp;</b> <a href='https://twitter.com/hoprnet/status/1666430539656581120' target='_blank'> Discovered a medium severity bug in HOPR with $3.3M staked at the time of disclosure</a>  </li>
          ...
          <li style={{textAlign: 'left'}}> <b>[PRIVATE AUDIT] &nbsp; &nbsp;</b> <a href='https://twitter.com/stackingsalmon' target='_blank'>   Stacking Salmon</a> </li>
